    ...
    <div className="overflow-hidden">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <Link
              href="https://www.google.com/search?q=airwin+india+travel"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-white text-slate-700 border border-slate-200 hover:border-slate-300 hover:bg-slate-50 px-8 py-4 rounded-full font-bold text-lg transition-all shadow-sm hover:shadow-md"
            >
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-5xl font-bold mb-6">Get your Passport & Visa Processed today</h2>
